...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative min-h-svh flex items-start sm:items-center justify-center overflow-hidden pt-28 pb-24 sm:pt-32 sm:pb-28 lg:pt-24">
      ...
      />
      <motion.div
        className="absolute top-24 -left-20 w-125 h-125 bg-cyan-500/10 rounded-full blur-3xl pointer-events-none"
        animate={{ scale: [1, 1.15, 1], opacity: [0.6, 1, 0.6] }}
        transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div
        className="absolute top-1/3 -right-20 w-100 h-100 bg-violet-500/10 rounded-full blur-3xl pointer-events-none"
      ...
      />
      <div className="absolute bottom-24 left-1/3 w-87.5 h-87.5 bg-blue-500/8 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        <motion.p
          ...
          career in IT. Passionate about systems, networking and software
          development.
        </motion.p>
